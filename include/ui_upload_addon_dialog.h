...
public:
    ...
    void setupUi(QDialog *upload_addon_dialog)
    {
        ...
        upload_addon_dialog->resize(650, 500);
        ...
        sizePolicy1.setHeightForWidth(addon_version->sizePolicy().hasHeightForWidth());
        addon_version->setSizePolicy(sizePolicy1);
        QFont font;
        font.setPointSize(9);
        ...
        sizePolicy2.setHeightForWidth(wow_version->sizePolicy().hasHeightForWidth());
        wow_version->setSizePolicy(sizePolicy2);
        ...
        sizePolicy1.setHeightForWidth(addon_name->sizePolicy().hasHeightForWidth());
        addon_name->setSizePolicy(sizePolicy1);
